          ...
          <div className="w-full">
            <form onSubmit={handleJoin} className="flex gap-2">
              <input 
                ...
                className="flex-1 bg-white/10 border border-white/20 rounded-xl px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-yellow-400"
              />
              <button 
                type="submit"
                className="bg-yellow-500 hover:bg-yellow-400 text-slate-900 font-bold px-6 py-3 rounded-xl transition-all flex items-center gap-2"
              >
                <UserPlus size={20} />
                Join
              </button>
